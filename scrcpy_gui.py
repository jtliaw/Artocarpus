...
# --- 语言字典 ---
LANGUAGES = {
    "app_title": {"zh": "Artocarpus (Scrcpy 图形界面) v6.0", "en": "Artocarpus (Scrcpy GUI) v6.0"},
    ...
    "tab_advanced": {"zh": "高级工具", "en": "Advanced Tools"},
    "camera_btn_tooltip": {"zh": "摄像头模式", "en": "Camera Mode"},
    "camera_window_title": {"zh": "📷 摄像头模式", "en": "📷 Camera Mode"},
    "camera_not_supported": {"zh": "摄像头模式目前仅支持 Linux 系统。", "en": "Camera mode is currently only supported on Linux."},
    "camera_device_label": {"zh": "选择设备:", "en": "Select Device:"},
    "camera_facing_label": {"zh": "摄像头:", "en": "Camera:"},
    "camera_facing_back": {"zh": "后置摄像头", "en": "Back Camera"},
    "camera_facing_front": {"zh": "前置摄像头", "en": "Front Camera"},
    "camera_mic_label": {"zh": "启用麦克风", "en": "Enable Microphone"},
    "camera_v4l2_label": {"zh": "虚拟摄像头设备:", "en": "Virtual Camera Device:"},
    "camera_v4l2_hint": {"zh": "（此功能是使用手机摄像头代替WebCam,将虚拟摄像头设备输入到你的软件内）", "en": "(This feature allows you to input a virtual camera device into your software using your phone's camera instead of a webcam.)"},
    "camera_start_btn": {"zh": "▶ 启动摄像头模式", "en": "▶ Start Camera Mode"},
    "camera_stop_btn": {"zh": "■ 停止", "en": "■ Stop"},
    "camera_running": {"zh": "摄像头模式运行中...", "en": "Camera mode running..."},
    "camera_no_device": {"zh": "请先选择设备。", "en": "Please select a device first."},
    "camera_v4l2_missing": {"zh": "未检测到 v4l2loopback 模块，请先安装：\nsudo apt install v4l2loopback-dkms\nsudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\"", "en": "v4l2loopback module not found. Please install it first:\nsudo apt install v4l2loopback-dkms\nsudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\""},
    "camera_install_hint": {"zh": "安装后运行: sudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\"", "en": "After install, run: sudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\""},
    "camera_v4l2_device_label": {"zh": "可用虚拟设备:", "en": "Available Virtual Device:"},
    "camera_v4l2_no_device": {"zh": "未找到可用的 /dev/video* 设备，请确认 v4l2loopback 已正确加载。\n运行: sudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\"", "en": "No /dev/video* device found. Please confirm v4l2loopback is loaded.\nRun: sudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\""},
    "camera_resolution_label": {"zh": "分辨率限制:", "en": "Max Resolution:"},
    "camera_load_v4l2_btn": {"zh": "🔌 加载 v4l2loopback", "en": "🔌 Load v4l2loopback"},
    "camera_v4l2_loading": {"zh": "正在加载模块，请在弹窗中输入密码...", "en": "Loading module, please enter password in dialog..."},
    "camera_v4l2_load_success": {"zh": "✓ v4l2loopback 已加载", "en": "✓ v4l2loopback loaded"},
    "camera_v4l2_load_fail": {"zh": "✗ 加载失败，请手动运行: sudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\"", "en": "✗ Load failed. Run manually: sudo modprobe v4l2loopback exclusive_caps=1 video_nr=10 card_label=\"Phone Camera\""},
    "adv_app_manager_frame": {"zh": "应用管理", "en": "App Manager"},
    "adv_warning_title": {"zh": "⚠ 危险操作警告", "en": "⚠ Danger Warning"},
    "adv_warning_text": {"zh": "此功能是卸载手机应用。\n用于卸载手机默认安装的软件，但不包括需要ROOT权限的软件。\n删除后的软件将无法在这里安装回，你需要为自己的操作负全部责任。", "en": "This function is uninstalls mobile applications.\nIt uninstalls the default software installed on your phone, but excludes software that requires root access.\nDeleted software cannot be reinstalled here; you are fully responsible for your actions."},
    "adv_scan_btn": {"zh": "我了解风险，开始扫描应用", "en": "I understand the risks, scan apps"},
    "adv_scanning": {"zh": "正在扫描应用，请稍候...", "en": "Scanning apps, please wait..."},
    "adv_search_placeholder": {"zh": "搜索应用名称或包名...", "en": "Search app name or package..."},
    "adv_select_all": {"zh": "全选", "en": "Select All"},
    "adv_deselect_all": {"zh": "取消全选", "en": "Deselect All"},
    "adv_show_system": {"zh": "显示系统应用", "en": "Show System Apps"},
    "adv_uninstall_btn": {"zh": "🗑 卸载所选应用", "en": "🗑 Uninstall Selected"},
    "adv_no_selection": {"zh": "请先勾选要卸载的应用。", "en": "Please select apps to uninstall first."},
    "adv_confirm1_title": {"zh": "第一次确认", "en": "First Confirmation"},
    "adv_confirm1_msg": {"zh": "你即将卸载以下 {} 个应用：\n{}\n\n此操作不可撤销，确定继续？", "en": "You are about to uninstall {} app(s):\n{}\n\nThis cannot be undone. Continue?"},
    "adv_confirm2_title": {"zh": "最终确认", "en": "Final Confirmation"},
    "adv_confirm2_msg": {"zh": "最后确认：真的要永久卸载这 {} 个应用吗？\n卸载后无法通过本工具恢复！", "en": "Final confirmation: permanently uninstall {} app(s)?\nThey cannot be restored through this tool!"},
    "adv_uninstalling": {"zh": "正在卸载: {}", "en": "Uninstalling: {}"},
    "adv_uninstall_done": {"zh": "✓ 卸载完成，共卸载 {} 个应用。", "en": "✓ Done, {} app(s) uninstalled."},
    "adv_no_device": {"zh": "请先选择设备再扫描。", "en": "Please select a device before scanning."},
    "adv_app_count": {"zh": "共找到 {} 个应用", "en": "Found {} apps total"},
    "adv_col_name": {"zh": "应用名称", "en": "App Name"},
    "adv_col_package": {"zh": "包名", "en": "Package Name"},
    "adv_col_type": {"zh": "类型", "en": "Type"},
    "adv_type_system": {"zh": "系统", "en": "System"},
    "adv_type_user": {"zh": "用户", "en": "User"},
}
...
class ScrcpyGUI:
    ...
    # 设置窗口图标
        ...
        self.notebook.add(self.tab5_frame, text=self._("tab_advanced"))
        self.tab6_frame = ttk.Frame(self.notebook)
        self.notebook.add(self.tab6_frame, text=self._("tab_about"))

        self._create_tab1_widgets()
        self._create_tab2_widgets()
        self._create_tab3_widgets()
        self._create_tab4_shortcuts()
        self._create_tab5_advanced()
        self._create_tab6_about()
    ...
    def _create_tab1_widgets(self):
        ...
        action_frame = ttk.Frame(parent); action_frame.grid(row=current_row, column=0, columnspan=4, sticky="ew", padx=5, pady=5)
        action_frame.grid_columnconfigure(0, weight=1); action_frame.grid_columnconfigure(1, weight=1)
        self.btn_connect_selected = ttk.Button(action_frame, text=self._("connect_device_button"), command=self.connect_selected_device); self.btn_connect_selected.grid(row=0, column=0, padx=5, pady=3, sticky="ew")
        self.btn_disconnect = ttk.Button(action_frame, text=self._("disconnect_button"), command=self.disconnect_scrcpy); self.btn_disconnect.grid(row=0, column=1, padx=5, pady=3, sticky="ew")
        self.btn_camera_mode = ttk.Button(action_frame, text="📷", width=4, command=self.open_camera_mode); self.btn_camera_mode.grid(row=0, column=2, padx=(0, 5), pady=3, sticky="e")
    ...
    def _create_tab6_about(self):
        parent = self.tab6_frame
        parent.columnconfigure(0, weight=1)

        # --- 关于软件 ---
        self.about_frame = ttk.LabelFrame(parent, text=self._("about_app_frame"))
        self.about_frame.grid(row=0, column=0, padx=10, pady=(10, 5), sticky="ew")
        self.about_frame.columnconfigure(0, weight=1)

        self.lbl_about_desc = ttk.Label(self.about_frame, text=self._("about_app_desc"), justify=tk.CENTER, anchor="center")
        self.lbl_about_desc.grid(row=0, column=0, padx=10, pady=(8, 2), sticky="ew")
        self.lbl_about_author = ttk.Label(self.about_frame, text=self._("about_author"), anchor="center")
        self.lbl_about_author.grid(row=1, column=0, padx=10, pady=2, sticky="ew")
        self.lbl_artocarpus_link = ttk.Label(self.about_frame, text=self._("about_github_link"),
        ...
        # --- Scrcpy 版本管理 ---
        self.scrcpy_ver_frame = ttk.LabelFrame(parent, text=self._("scrcpy_version_frame"))
        self.scrcpy_ver_frame.grid(row=1, column=0, padx=10, pady=5, sticky="ew")
        self.scrcpy_ver_frame.columnconfigure(1, weight=1)

        self.lbl_cur_ver_title = ttk.Label(self.scrcpy_ver_frame, text=self._("current_version_label"))
        self.lbl_cur_ver_title.grid(row=0, column=0, padx=10, pady=8, sticky="w")
        self.lbl_current_version = ttk.Label(self.scrcpy_ver_frame, text=self._("version_unknown"), font=("Arial", 10, "bold"))
        self.lbl_current_version.grid(row=0, column=1, padx=5, pady=8, sticky="w")
        self.btn_check_update = ttk.Button(self.scrcpy_ver_frame, text=self._("btn_check_update"), command=self.check_scrcpy_update, width=16)
        self.btn_check_update.grid(row=0, column=2, padx=10, pady=8, sticky="e")

        self.lbl_lat_ver_title = ttk.Label(self.scrcpy_ver_frame, text=self._("latest_version_label"))
        self.lbl_lat_ver_title.grid(row=1, column=0, padx=10, pady=8, sticky="w")
        self.lbl_latest_version = ttk.Label(self.scrcpy_ver_frame, text="—", font=("Arial", 10, "bold"))
        self.lbl_latest_version.grid(row=1, column=1, padx=5, pady=8, sticky="w")
        self.btn_do_update = ttk.Button(self.scrcpy_ver_frame, text=self._("btn_do_update"), command=self.do_scrcpy_update, width=16, state=tk.DISABLED)
        self.btn_do_update.grid(row=1, column=2, padx=10, pady=8, sticky="e")

        self.lbl_update_status = ttk.Label(self.scrcpy_ver_frame, text="", foreground="gray")
        self.lbl_update_status.grid(row=2, column=0, columnspan=2, padx=10, pady=(0, 8), sticky="w")
        self.lbl_scrcpy_release_link = ttk.Label(self.scrcpy_ver_frame, text=self._("btn_open_release"),
                                                   foreground="#0066cc", cursor="hand2", font=("Arial", 10, "underline"))
    ...
    def open_camera_mode(self):
        if os.name == 'nt':
            messagebox.showinfo(self._("info"), self._("camera_not_supported"), parent=self.master)
            return
        win = tk.Toplevel(self.master)
        win.title(self._("camera_window_title"))
        ...
        # 设备选择
        ttk.Label(win, text=self._("camera_device_label")).grid(row=0, column=0, padx=10, pady=8, sticky="w")
        cam_device_var = tk.StringVar()
        devices = list(self.combo_devices["values"]) if self.combo_devices["values"] else []
        combo_cam_dev = ttk.Combobox(win, textvariable=cam_device_var, values=devices, state="readonly", width=28)
        if devices: combo_cam_dev.current(0)
        combo_cam_dev.grid(row=0, column=1, padx=10, pady=8, sticky="ew")

        # 前置/后置
        ttk.Label(win, text=self._("camera_facing_label")).grid(row=1, column=0, padx=10, pady=8, sticky="w")
        facing_var = tk.StringVar(value="back")
        facing_frame = ttk.Frame(win)
        facing_frame.grid(row=1, column=1, padx=10, pady=8, sticky="w")
        ttk.Radiobutton(facing_frame, text=self._("camera_facing_back"), variable=facing_var, value="back").pack(side=tk.LEFT, padx=5)
        ttk.Radiobutton(facing_frame, text=self._("camera_facing_front"), variable=facing_var, value="front").pack(side=tk.LEFT, padx=5)

        # 分辨率限制
        ttk.Label(win, text=self._("camera_resolution_label")).grid(row=2, column=0, padx=10, pady=5, sticky="w")
        res_frame = ttk.Frame(win)
        res_frame.grid(row=2, column=1, padx=10, pady=5, sticky="w")
        res_var = tk.StringVar(value="1280")
        for r in ["640", "1280", "1920"]:
            ttk.Radiobutton(res_frame, text=r, variable=res_var, value=r).pack(side=tk.LEFT, padx=4)

        # v4l2 虚拟设备 — 自动扫描可用设备
        ttk.Label(win, text=self._("camera_v4l2_label")).grid(row=3, column=0, padx=10, pady=(8, 0), sticky="w")
        v4l2_var = tk.StringVar(value="/dev/video10")
        import glob
        available_v4l2 = sorted(glob.glob("/dev/video*"))
        if available_v4l2:
            v4l2_combo = ttk.Combobox(win, textvariable=v4l2_var, values=available_v4l2, width=18)
            preferred = [d for d in available_v4l2 if int(d.replace("/dev/video", "") or 0) >= 10]
            v4l2_var.set(preferred[0] if preferred else available_v4l2[-1])
            v4l2_combo.grid(row=3, column=1, padx=10, pady=(8, 0), sticky="w")
        else:
            ttk.Entry(win, textvariable=v4l2_var, width=20).grid(row=3, column=1, padx=10, pady=(8, 0), sticky="w")

        ttk.Label(win, text=self._("camera_v4l2_hint"), foreground="gray",
                  wraplength=300, justify=tk.LEFT).grid(row=4, column=0, columnspan=2, padx=10, pady=(2, 5), sticky="w")

        # 状态标签
        status_lbl = ttk.Label(win, text="", foreground="gray")
        status_lbl.grid(row=5, column=0, columnspan=2, padx=10, pady=2, sticky="w")
        ...
        def load_v4l2():
            """用 pkexec 图形化询问密码来加载 v4l2loopback 模块"""
            import subprocess as _sp
            status_lbl.config(text=self._("camera_v4l2_loading"), foreground="gray")
            btn_load.config(state=tk.DISABLED)
            def do_load():
                try:
                    result = _sp.run(
                        ["pkexec", "modprobe", "v4l2loopback", "exclusive_caps=1", "video_nr=10", "card_label=Phone Camera"],
                        capture_output=True, text=True, timeout=30
                    )
                    if result.returncode == 0:
                        new_devices = sorted(glob.glob("/dev/video*"))
                        def update_ui_ok():
                            status_lbl.config(text=self._("camera_v4l2_load_success"), foreground="green")
                            btn_load.config(state=tk.NORMAL)
                            self.log_status("v4l2loopback 模块已加载")
                            if new_devices:
                                try:
                                    v4l2_combo.config(values=new_devices)
                                    preferred2 = [d for d in new_devices if int(d.replace("/dev/video", "") or 0) >= 10]
                                    v4l2_var.set(preferred2[0] if preferred2 else new_devices[-1])
                                except Exception:
                                    pass
                        win.after(0, update_ui_ok)
                    else:
                        def update_ui_fail():
                            status_lbl.config(text=self._("camera_v4l2_load_fail"), foreground="red")
                            btn_load.config(state=tk.NORMAL)
                            self.log_status(f"v4l2loopback 加载失败: {result.stderr.strip()}")
                        win.after(0, update_ui_fail)
                except Exception as e:
                    win.after(0, lambda: (
                        status_lbl.config(text=str(e), foreground="red"),
                        btn_load.config(state=tk.NORMAL)
                    ))
            threading.Thread(target=do_load, daemon=True).start()

        def start_camera():
            serial = cam_device_var.get().strip()
            if not serial:
                status_lbl.config(text=self._("camera_no_device"), foreground="red")
                return
            import subprocess as _sp
            chk = _sp.run(["lsmod"], capture_output=True, text=True)
            if "v4l2loopback" not in chk.stdout:
                messagebox.showwarning(self._("warning"), self._("camera_v4l2_missing"), parent=win)
                return
            v4l2_dev = v4l2_var.get().strip()
            if not os.path.exists(v4l2_dev):
                messagebox.showwarning(self._("warning"), self._("camera_v4l2_no_device"), parent=win)
                return
            scrcpy_exec = self.entry_scrcpy_path.get().strip()
            cmd = [
                scrcpy_exec,
                f"--serial={serial}",
                "--video-source=camera",
                f"--camera-facing={facing_var.get()}",
                "--video-codec=h264",
                f"--max-size={res_var.get()}",
                f"--v4l2-sink={v4l2_dev}",
                "--no-video-playback",
                "--no-audio",
            ]
            self.log_status(f"启动摄像头模式: {' '.join(cmd)}")
            status_lbl.config(text=self._("camera_running"), foreground="green")
            btn_start.config(state=tk.DISABLED)
            btn_stop.config(state=tk.NORMAL)
            def run():
                cam_proc[0] = _sp.Popen(cmd, stdout=_sp.PIPE, stderr=_sp.PIPE,
                                         text=True, encoding="utf-8", errors="replace")
                stdout, stderr = cam_proc[0].communicate()
                combined = (stdout + stderr).strip()
                if cam_proc[0].returncode != 0:
                    self.log_status(f"摄像头模式退出: {combined}")
                else:
                    self.log_status("摄像头模式已结束。")
                win.after(0, lambda: (
                    status_lbl.config(text="", foreground="gray"),
        ...
        def stop_camera():
            if cam_proc[0] and cam_proc[0].poll() is None:
                cam_proc[0].terminate()
            status_lbl.config(text="", foreground="gray")
            btn_start.config(state=tk.NORMAL)
            btn_stop.config(state=tk.DISABLED)
        ...
        btn_load = ttk.Button(btn_frame, text=self._("camera_load_v4l2_btn"), command=load_v4l2, width=16)
        btn_load.pack(side=tk.LEFT, padx=5)
        btn_start = ttk.Button(btn_frame, text=self._("camera_start_btn"), command=start_camera, width=16)
        btn_start.pack(side=tk.LEFT, padx=5)
        btn_stop = ttk.Button(btn_frame, text=self._("camera_stop_btn"), command=stop_camera, width=6, state=tk.DISABLED)
    ...
    # Tab6 — 高级工具（应用管理）
    # ─────────────────────────────────────────────
    def _create_tab5_advanced(self):
        ...
        dev_frame.grid(row=0, column=0, padx=10, pady=(10, 5), sticky="ew")
        dev_frame.columnconfigure(1, weight=1)
        self.lbl_adv_device = ttk.Label(dev_frame, text=self._("devices_label"))
        self.lbl_adv_device.pack(side=tk.LEFT, padx=5)
        self.combo_adv_device_var = tk.StringVar()
        self.combo_adv_device = ttk.Combobox(dev_frame, textvariable=self.combo_adv_device_var, state="readonly", width=30)
        self.combo_adv_device.pack(side=tk.LEFT, padx=5, fill="x", expand=True)

        # 警告框
        self.warn_frame = ttk.LabelFrame(parent, text=self._("adv_warning_title"))
        self.warn_frame.grid(row=1, column=0, padx=10, pady=5, sticky="ew")
        self.warn_frame.columnconfigure(0, weight=1)
        self.lbl_adv_warning = ttk.Label(self.warn_frame, text=self._("adv_warning_text"),
                                          foreground="#cc3300", justify=tk.LEFT, wraplength=620)
        self.lbl_adv_warning.grid(row=0, column=0, padx=10, pady=8, sticky="w")
        self.btn_adv_scan = ttk.Button(self.warn_frame, text=self._("adv_scan_btn"), command=self._adv_scan_apps)
        self.btn_adv_scan.grid(row=1, column=0, padx=10, pady=(0, 10))

        # 应用列表区（初始隐藏，扫描后显示）
        self.adv_list_frame = ttk.Frame(parent)
        self.adv_list_frame.grid(row=2, column=0, padx=10, pady=5, sticky="nsew")
        self.adv_list_frame.columnconfigure(0, weight=1)
        self.adv_list_frame.rowconfigure(1, weight=1)
        self.adv_list_frame.grid_remove()  # 初始隐藏

        # 搜索和过滤行
        filter_frame = ttk.Frame(self.adv_list_frame)
        filter_frame.grid(row=0, column=0, sticky="ew", pady=(0, 5))
        filter_frame.columnconfigure(1, weight=1)
        self.adv_search_var = tk.StringVar()
        self.adv_search_var.trace_add("write", self._adv_filter_apps)
        ttk.Entry(filter_frame, textvariable=self.adv_search_var, width=25).pack(side=tk.LEFT, padx=(0, 5))
        self.adv_show_system_var = tk.BooleanVar(value=False)
        ttk.Checkbutton(filter_frame, text=self._("adv_show_system"),
                        variable=self.adv_show_system_var,
                        command=self._adv_filter_apps).pack(side=tk.LEFT, padx=5)
        ttk.Button(filter_frame, text=self._("adv_select_all"), command=self._adv_select_all, width=8).pack(side=tk.RIGHT, padx=2)
        ttk.Button(filter_frame, text=self._("adv_deselect_all"), command=self._adv_deselect_all, width=8).pack(side=tk.RIGHT, padx=2)
        self.lbl_adv_count = ttk.Label(filter_frame, text="", foreground="gray")
        self.lbl_adv_count.pack(side=tk.RIGHT, padx=10)

        # 应用列表（Treeview with checkboxes via tags）
        list_container = ttk.Frame(self.adv_list_frame)
        list_container.grid(row=1, column=0, sticky="nsew")
        list_container.columnconfigure(0, weight=1)
        list_container.rowconfigure(0, weight=1)
        self.adv_tree = ttk.Treeview(list_container,
                                      columns=("check", "name", "package", "type"),
                                      show="headings", selectmode="browse", height=12)
        self.adv_tree.heading("check", text="✓", anchor="center")
        self.adv_tree.heading("name", text=self._("adv_col_name"))
        self.adv_tree.heading("package", text=self._("adv_col_package"))
        self.adv_tree.heading("type", text=self._("adv_col_type"))
        self.adv_tree.column("check", width=35, anchor="center", stretch=False)
        self.adv_tree.column("name", width=160)
        self.adv_tree.column("package", width=260)
        self.adv_tree.column("type", width=70, anchor="center")
        self.adv_tree.tag_configure("checked", background="#e8f5e9")
        self.adv_tree.tag_configure("system", foreground="#888888")
        self.adv_tree.bind("<Button-1>", self._adv_toggle_check)
        vsb = ttk.Scrollbar(list_container, orient="vertical", command=self.adv_tree.yview)
        self.adv_tree.configure(yscrollcommand=vsb.set)
        self.adv_tree.grid(row=0, column=0, sticky="nsew")
        vsb.grid(row=0, column=1, sticky="ns")

        # 卸载按钮
        self.btn_adv_uninstall = ttk.Button(self.adv_list_frame, text=self._("adv_uninstall_btn"),
                                             command=self._adv_uninstall_selected)
        self.btn_adv_uninstall.grid(row=2, column=0, pady=8)

        # 内部数据
        self._adv_all_apps = []       # [(name, package, is_system), ...]
        self._adv_checked = set()     # 勾选的包名集合
        self._adv_visible = []        # 当前显示的包名列表

    def _adv_scan_apps(self):
        serial = self.combo_adv_device_var.get().strip()
        if not serial:
            messagebox.showerror(self._("error"), self._("adv_no_device"), parent=self.master)
            return
        self.btn_adv_scan.config(state=tk.DISABLED, text=self._("adv_scanning"))
        def scan():
            try:
                # 获取所有包（含系统）
                res_all = subprocess.run(
                    [self.adb_executable_path, "-s", serial, "shell", "pm", "list", "packages", "-f"],
                    capture_output=True, text=True, timeout=30, encoding='utf-8', errors='replace'
                )
                # 获取系统包
                res_sys = subprocess.run(
                    [self.adb_executable_path, "-s", serial, "shell", "pm", "list", "packages", "-s"],
                    capture_output=True, text=True, timeout=30, encoding='utf-8', errors='replace'
                )
                system_pkgs = set()
                for line in res_sys.stdout.strip().splitlines():
                    if line.startswith("package:"):
                        system_pkgs.add(line[8:].strip())
                apps = []
                for line in res_all.stdout.strip().splitlines():
                    ...
                    try:
                        ...
                        label_res = subprocess.run(
                            [self.adb_executable_path, "-s", serial, "shell",
                             "cmd", "package", "resolve-activity", "--brief", pkg],
                            capture_output=True, text=True, timeout=5, encoding='utf-8', errors='replace'
                        )
                        # 简单用包名最后段作为显示名
                        display_name = pkg.split(".")[-1].replace("_", " ").title()
                        is_sys = pkg in system_pkgs
                        apps.append((display_name, pkg, is_sys))
                    except Exception:
                        continue
                apps.sort(key=lambda x: (x[2], x[1]))  # 先用户应用，再系统应用
                self.master.after(0, lambda: self._adv_populate(apps))
            except Exception as e:
                self.master.after(0, lambda: (
                    self.btn_adv_scan.config(state=tk.NORMAL, text=self._("adv_scan_btn")),
                    self.log_status(f"扫描应用失败: {e}")
                ))
        threading.Thread(target=scan, daemon=True).start()

    def _adv_populate(self, apps):
        self._adv_all_apps = apps
        self._adv_checked = set()
        self.btn_adv_scan.config(state=tk.NORMAL, text=self._("adv_scan_btn"))
        self.adv_list_frame.grid()
        self._adv_filter_apps()

    def _adv_filter_apps(self, *_):
        query = self.adv_search_var.get().lower()
        show_sys = self.adv_show_system_var.get()
        self.adv_tree.delete(*self.adv_tree.get_children())
        self._adv_visible = []
        for name, pkg, is_sys in self._adv_all_apps:
            if is_sys and not show_sys: continue
            if query and query not in name.lower() and query not in pkg.lower(): continue
            self._adv_visible.append(pkg)
            checked = "☑" if pkg in self._adv_checked else "☐"
            type_label = self._("adv_type_system") if is_sys else self._("adv_type_user")
            tags = []
            if pkg in self._adv_checked: tags.append("checked")
            if is_sys: tags.append("system")
            self.adv_tree.insert("", "end", iid=pkg, values=(checked, name, pkg, type_label), tags=tags)
        self.lbl_adv_count.config(text=self._("adv_app_count").format(len(self._adv_visible)))

    def _adv_toggle_check(self, event):
        row = self.adv_tree.identify_row(event.y)
        if not row: return
        if row in self._adv_checked:
            self._adv_checked.discard(row)
        else:
            self._adv_checked.add(row)
        self._adv_filter_apps()

    def _adv_select_all(self):
        self._adv_checked = set(self._adv_visible)
        self._adv_filter_apps()

    def _adv_deselect_all(self):
        self._adv_checked = set()
        self._adv_filter_apps()

    def _adv_uninstall_selected(self):
        if not self._adv_checked:
            messagebox.showwarning(self._("warning"), self._("adv_no_selection"), parent=self.master)
            return
        serial = self.combo_adv_device_var.get().strip()
        pkgs = list(self._adv_checked)
        pkg_preview = "\n".join(pkgs[:10]) + (f"\n...等共 {len(pkgs)} 个" if len(pkgs) > 10 else "")
        # 第一次确认
        if not messagebox.askyesno(
            self._("adv_confirm1_title"),
            self._("adv_confirm1_msg").format(len(pkgs), pkg_preview),
            parent=self.master, icon="warning"
        ): return
        # 第二次确认
        if not messagebox.askyesno(
            self._("adv_confirm2_title"),
            self._("adv_confirm2_msg").format(len(pkgs)),
            parent=self.master, icon="warning"
        ): return
        # 执行卸载
        self.btn_adv_uninstall.config(state=tk.DISABLED)
        def do_uninstall():
            success_count = 0
            for pkg in pkgs:
                self.master.after(0, lambda p=pkg: self.log_status(self._("adv_uninstalling").format(p)))
                res = subprocess.run(
                    [self.adb_executable_path, "-s", serial, "shell", "pm", "uninstall", "-k", "--user", "0", pkg],
                    capture_output=True, text=True, timeout=30, encoding='utf-8', errors='replace'
                )
                if "Success" in res.stdout:
                    success_count += 1
                else:
                    self.master.after(0, lambda p=pkg, r=res.stdout.strip():
                        self.log_status(f"✗ 卸载失败 {p}: {r}"))
            def finish():
                self.log_status(self._("adv_uninstall_done").format(success_count))
                self.btn_adv_uninstall.config(state=tk.NORMAL)
                self._adv_checked.clear()
                self._adv_scan_apps()  # 重新扫描刷新列表
    ...
    def update_all_ui_texts(self):
        ...
        if self.notebook.index("end") > 4:
            self.notebook.tab(self.tab5_frame, text=self._("tab_advanced"))
            self.lbl_adv_device.config(text=self._("devices_label"))
            self.warn_frame.config(text=self._("adv_warning_title"))
            self.lbl_adv_warning.config(text=self._("adv_warning_text"))
            self.btn_adv_scan.config(text=self._("adv_scan_btn"))
            self.btn_adv_uninstall.config(text=self._("adv_uninstall_btn"))
            self.adv_tree.heading("name", text=self._("adv_col_name"))
            self.adv_tree.heading("package", text=self._("adv_col_package"))
            self.adv_tree.heading("type", text=self._("adv_col_type"))
        if self.notebook.index("end") > 5:
            self.notebook.tab(self.tab6_frame, text=self._("tab_about"))
            self.about_frame.config(text=self._("about_app_frame"))
            ...
            self.scrcpy_ver_frame.config(text=self._("scrcpy_version_frame"))
        ...
        # 刷新「尚未选择」占位文字（仅当用户还没选择路径时）
        if self.pull_dest_pc_path_var.get() in ("尚未选择", "Not Selected"):
            self.pull_dest_pc_path_var.set(self._("path_not_selected"))
        if self.push_source_pc_path_var.get() in ("尚未选择", "Not Selected"):
            self.push_source_pc_path_var.set(self._("path_not_selected"))
        # 第1页控件文字更新
    ...
    def refresh_device_list(self):
        ...
        try:
            ...
            # 更新"高级工具"页面的设备列表
            if hasattr(self, 'combo_adv_device'):
                self.combo_adv_device['values'] = device_list
                if device_list:
                    self.combo_adv_device.current(0)
                else:
                    self.combo_adv_device.set('')
    ...
    def _on_tab_changed(self, event=None):
        """切换到第6页时隐藏状态栏腾出空间，离开时恢复"""
        try:
            current = self.notebook.index(self.notebook.select())
            if current == 4:  # tab5 高级工具（index从0开始，第5页=4）
                self.status_frame_container.pack_forget()
                self.notebook.pack_configure(expand=True, fill="both")
            else:
                # 恢复状态栏
                if not self.status_frame_container.winfo_ismapped():
                    self.notebook.pack_configure(expand=True, fill="both")
                    self.status_frame_container.pack(pady=(0, 10), padx=10, fill="x", expand=False)
        except Exception:
            pass
