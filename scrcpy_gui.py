...
LANGUAGES = {
    ...
    "camera_v4l2_missing": {"zh": "未检测到 v4l2loopback 模块，请先安装：\nsudo apt install v4l2loopback-dkms\nsudo modprobe v4l2loopback", "en": "v4l2loopback module not found. Please install it first:\nsudo apt install v4l2loopback-dkms\nsudo modprobe v4l2loopback"},
    "camera_install_hint": {"zh": "安装后运行: sudo modprobe v4l2loopback", "en": "After install, run: sudo modprobe v4l2loopback"},
    "camera_v4l2_device_label": {"zh": "可用虚拟设备:", "en": "Available Virtual Device:"},
    "camera_v4l2_no_device": {"zh": "未找到可用的 /dev/video* 设备，请确认 v4l2loopback 已正确加载。\n运行: sudo modprobe v4l2loopback", "en": "No /dev/video* device found. Please confirm v4l2loopback is loaded.\nRun: sudo modprobe v4l2loopback"},
    ...
    "camera_v4l2_load_fail": {"zh": "✗ 加载失败，请手动运行: sudo modprobe v4l2loopback", "en": "✗ Load failed. Run manually: sudo modprobe v4l2loopback"},
...
class ScrcpyGUI:
    ...
    def open_camera_mode(self):
        ...
        v4l2_var = tk.StringVar(value="/dev/video2")
        import glob
        ...
        if available_v4l2:
            ...
            preferred = [d for d in available_v4l2 if int(d.replace("/dev/video", "") or 0) >= 2]
                        ...
                        def update_ui_ok():
                            ...
                            if new_devices:
                                try:
                                    ...
                                    preferred2 = [d for d in new_devices if int(d.replace("/dev/video", "") or 0) >= 2]
